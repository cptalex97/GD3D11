...
VS_OUTPUT VSMain( VS_INPUT Input )
{
    ...
    // GOUC: 0.0 here made every blended static vob (material alpha BLEND/ADD, e.g. spider webs)
    // fully transparent in DrawFrameAlphaMeshes. Taken from upstream 1396ecc9 / #519.
